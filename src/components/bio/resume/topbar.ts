                ...
                if (name === "resumes") {
                                    ...
                                    if (e) {
                                        ...
                                        Topbar.executeOpen({
                                            ...
                                            func: (openCont) => {
                                                ...
                                                this.viewResume.showResume({
                                                    parent: openCont, mainResume, french,
                    ...
                    createBtn.onclick = (e: MouseEvent) => {
                        ...
                        Topbar.executeOpen({
                            ...
                            show: true,
                            func: (openCont) => {
                                this.createResume.main({
                                    parent, innerParent: openCont, french,
                                    func: async (mainResumes, mainResume) => {
                                        ...
                                        this.viewResume.showResume({
                                            parent: mainContainer, mainResume: mainResume, french,
                                            func1: async (mainResumes, nameResumes) => {
                            ...
                            if (name) {
                                ...
                                button.onclick = (e: MouseEvent) => {
                                    ...
                                    Topbar.executeOpen({
                                        ...
                                        func: (openCont) => {
                                            this.resumeRef.main({
                                                parent: openCont, name: name.name, less400, less900, css_col, css_row, french, buttonEffect: false, toPrint: true,
                    ...
                    create_ref.onclick = (e: MouseEvent) => {
                        ...
                        Topbar.executeOpen({
                            ...
                            func: (openCont) => {
                                this.createRef.main({
                                    parent: openCont, user: this.user, french,
                                    func: async (mainRefs) => {
                                        this.mainRefs = mainRefs;
                    ...
                    letter.onclick = (e: MouseEvent) => {
                        ...
                        Topbar.executeOpen({
                            ...
                            show: true,
                            func: (openCont) => {
                                this.letterEditor.newLetter({
                                    parent: openCont, french,
                            ...
                            if (nameLetter) {
                                ...
                                editLetter.onclick = (e: MouseEvent) => {
                                    ...
                                    Topbar.executeOpen({
                                        ...
                                        show: true,
                                        func: (openCont) => {
                                            this.letterEditor.editLetter({
                                                parent: openCont, filename: name, french,
                                                func1: async (mainLetters, nameLetters) => {
                                                    //DELETE && SAVE
                        ...
                        this.nameLetters.map(namelet => {
                            ...
                            nameLetBtn.onclick = (e: MouseEvent) => {
                                if (e) {
                                    ...
                                    const newUrl = new URL(`/letter/print/${name}`, location.origin);
