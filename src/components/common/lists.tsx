...
export const cssClassArr: cssClassType[] = [
    ...
    { headerType: "custom", level: "col", eleType: "div", id: "colId", loc: "flexbox", type: "customHeader", className: " column mx-auto  ", key: undefined, css: "position:relative;height:100%;min-height:inherit;display:flex;flex-direction:column;border-radius:10px;border:none;" },
    { headerType: "normal", level: "col", eleType: "div", id: "colId", loc: "flexbox", type: "header", className: " column mx-auto  ", key: undefined, css: "position:relative;height:100%;min-height:inherit;display:flex;flex-direction:column;border-radius:10px;border:none;" },
